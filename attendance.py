...
trainimagelabel_path = (
    r"C:\Users\DELL\Desktop\Attendance-Management-system-using-face-recognition\TrainingImageLabel\Trainner.yml"
)
...
studentdetail_path = (
    r"C:\Users\DELL\Desktop\Attendance-Management-system-using-face-recognition\StudentDetails\studentdetails.csv"
)
...
logo = Image.open(r"c:\Users\DELL\Desktop\pict.jpg")
...
ri = Image.open(r"c:\Users\DELL\Desktop\pict.jpg")
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=100, y=270)

ai = Image.open(r"c:\Users\DELL\Desktop\pict.jpg")
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=980, y=270)

vi = Image.open(r"c:\Users\DELL\Desktop\pict.jpg")
